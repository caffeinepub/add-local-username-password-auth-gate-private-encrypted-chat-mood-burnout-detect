  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="space-y-3">
        <Label htmlFor="category" className="text-lg font-semibold popup-text-high-contrast">
          Detected Category
        </Label>
      ...
      <div className="space-y-3">
        <Label htmlFor="message" className="text-lg font-semibold popup-text-high-contrast">
