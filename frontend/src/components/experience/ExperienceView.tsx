...
export default function ExperienceView({ onClose }: ExperienceViewProps) {
  ...
  const [activeTab, setActiveTab] = useState<'experience' | 'inbox' | 'statistics'>('experience');
    ...
    <div className="min-h-screen bg-background flex flex-col">
      <div className="flex-grow px-4 py-8">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          {/* Main content area */}
          {isAdmin ? (
            <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'experience' | 'inbox' | 'statistics')} className="w-full">
