          ...
          <div className="rounded-[22px] bg-crisis-surface p-8 sm:p-10 text-center space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-base sm:text-lg text-white/90 leading-relaxed">
                We hear you, and we care deeply about your wellbeing. Whatever you're going through right now, 
                please know that your life has immense value and there are people who want to help.
              </p>
            </div>
            ...
            <div className="bg-white/10 rounded-2xl p-5 space-y-3 border border-white/20">
              ...
              <p className="text-base sm:text-lg text-white font-medium">
                A complimentary <span className="font-bold text-crisis-highlight">30-minute session</span> with a real therapist is available to you right now.
              </p>
            ...
            <p className="text-sm text-white/70 leading-relaxed">
              Taking this step takes courage. You deserve support, compassion, and care — and help is just a call away.
            </p>
