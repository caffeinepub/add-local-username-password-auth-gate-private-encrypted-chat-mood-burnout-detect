...
export default function ZoomTransition({ children, className = '', delay = 0 }: ZoomTransitionProps) {
  ...
  return (
    <div
      ...
      style={{
        opacity: isVisible ? 1 : 0,
        transform: isVisible ? 'scale(1)' : `scale(${ZOOM_CONFIG.component.scaleFrom})`,
